		...
		if(IF_OF_Latch.isOF_enable())
		{
			...
			switch(optype){
				case 1://R3 format
							...
							OF_EX_Latch.set_pc_val(IF_OF_Latch.get_pc_val());
			...
			if (optype == 1){
				...
				if (conflict){
					System.out.println("reason of conflict");
			...
			if(conflict){
				...
				// brought inside the loop from outside
			...
			System.out.println("OF-latch disable");
		}
	}
